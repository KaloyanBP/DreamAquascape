namespace DreamAquascape.GCommon
{
    public static class ExceptionMessages
    {
        ...
        public const string ContestNotFoundErrorMessage = "Contest not found";
        ...
        public const string DatabaseConnectionFailedMessage = "Failed to connect to the database.";
    }
}
