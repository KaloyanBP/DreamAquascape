...
namespace DreamAquascape.Data.Migrations
{
    ...
    [Migration("20250720083447_InitialContestDB")]
    partial class InitialContestDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamAquascape.Data.Models.UserContestParticipation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("EntrySubmittedAt")
                        .HasColumnType("datetime2");

                    b.Property<bool>("HasSubmittedEntry")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int?>("SubmittedEntryId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("VotedForEntryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubmittedEntryId");

                    b.HasIndex("UserId");

                    b.HasIndex("VotedForEntryId");

                    b.ToTable("UserContestParticipations", t =>
                        {
                            t.HasComment("Tracks all user activities in contests in a central place");
                        });
                });
            ...
            modelBuilder.Entity("DreamAquascape.Data.Models.Contest", b =>
                {
                    b.HasOne("DreamAquascape.Data.Models.ContestEntry", "WinnerEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("DreamAquascape.Data.Models.UserContestParticipation", b =>
                {
                    ...
                    b.HasOne("DreamAquascape.Data.Models.ContestEntry", "SubmittedEntry")
                        .WithMany()
                        .HasForeignKey("SubmittedEntryId")
                    ...
                    b.HasOne("DreamAquascape.Data.Models.ContestEntry", "VotedForEntry")
                        .WithMany()
                        .HasForeignKey("VotedForEntryId")
                        .OnDelete(DeleteBehavior.NoAction);
